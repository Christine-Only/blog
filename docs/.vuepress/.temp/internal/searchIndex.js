export const searchIndex = [
  ...
  },
  {
    ...
    "headers": [
      ...
      {
        "level": 2,
        "title": "配置.prettierrc.js",
        "slug": "配置-prettierrc-js",
        "link": "#配置-prettierrc-js",
        "children": []
      },
      {
        "level": 2,
  ...
  },
  {
    ...
    "headers": [
      {
        "level": 2,
        "title": "安装stylelint及依赖包",
        "slug": "安装stylelint及依赖包",
        "link": "#安装stylelint及依赖包",
        "children": []
      },
      {
        "level": 2,
        "title": "根目录创建 .stylelintrc.js 文件",
        "slug": "根目录创建-stylelintrc-js-文件",
        "link": "#根目录创建-stylelintrc-js-文件",
        "children": []
      },
      {
        "level": 2,
  ...
  },
  {
    ...
    "headers": [
      ...
      {
        "level": 2,
        "title": "前端网站容灾 - CDN主域重试方案",
        "slug": "前端网站容灾-cdn主域重试方案",
        "link": "#前端网站容灾-cdn主域重试方案",
        "children": []
      }
    ],
    "path": "/advance/umi.html",
    "pathLocale": "/",
    "extraFields": []
  },
  {
    ...
    "headers": [
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "level": 3,
            "title": "构造函数、实例、原型三者之间的关系",
            "slug": "构造函数、实例、原型三者之间的关系",
            "link": "#构造函数、实例、原型三者之间的关系",
            "children": []
          },
          {
            "level": 3,
          ...
          {
            "level": 3,
            "title": "Object.prototype成员介绍",
            "slug": "object-prototype成员介绍",
            "link": "#object-prototype成员介绍",
            "children": []
          }
        ]
      },
  ...
  },
  {
    ...
    "headers": [
      {
        "level": 2,
        "title": "call、apply 及 bind 区别",
        "slug": "call、apply-及-bind-区别",
        "link": "#call、apply-及-bind-区别",
        "children": [
          {
            "level": 3,
            "title": "作用",
      ...
      {
        "level": 2,
        "title": "实现 call、apply 及 bind 函数",
        "slug": "实现-call、apply-及-bind-函数",
        "link": "#实现-call、apply-及-bind-函数",
        "children": [
          {
            "level": 3,
            "title": "call的实现",
  ...
  },
  {
    ...
    "headers": [
      ...
      },
      {
        ...
        "slug": "set、weakset、map、weakmap",
        "link": "#set、weakset、map、weakmap",
        "children": [
          {
            "level": 3,
            "title": "Set（集合）",
      ...
      },
      {
        ...
        "children": [
          ...
          },
          {
            ...
            "link": "#关于73以下版本和73版本的区别",
            "children": []
          }
        ]
      }
    ],
    "path": "/interview/eventLoop.html",
    "pathLocale": "/",
    "extraFields": []
  },
  {
    ...
    "headers": [
      ...
      {
        "level": 2,
        "title": "实现 Promise 及相关方法",
        "slug": "实现-promise-及相关方法",
        "link": "#实现-promise-及相关方法",
        "children": [
          {
            "level": 3,
            "title": "🌰",
      ...
      {
        "level": 2,
        "title": "模拟实现 setInterval",
        "slug": "模拟实现-setinterval",
        "link": "#模拟实现-setinterval",
        "children": [
          {
            "level": 3,
            "title": "🌰",
      ...
      {
        "level": 2,
        "title": "模拟实现 settimeout",
        "slug": "模拟实现-settimeout",
        "link": "#模拟实现-settimeout",
        "children": [
          {
            "level": 3,
            "title": "🌰",
      ...
      {
        "level": 2,
        "title": "实现一个对象的 flatten 功能",
        "slug": "实现一个对象的-flatten-功能",
        "link": "#实现一个对象的-flatten-功能",
        "children": []
      },
      {
        "level": 2,
      ...
      {
        "level": 2,
        "title": "实现虚拟 dom 转换为真实 dom",
        "slug": "实现虚拟-dom-转换为真实-dom",
        "link": "#实现虚拟-dom-转换为真实-dom",
        "children": []
      },
      {
        "level": 2,
      ...
      {
        "level": 2,
        "title": "实现数组去重（要求最佳时间复杂度）",
        "slug": "实现数组去重-要求最佳时间复杂度",
        "link": "#实现数组去重-要求最佳时间复杂度",
        "children": []
      },
      {
        "level": 2,
        "title": "实现获取数组第二大的数（要求时间复杂度 O(n)）",
        "slug": "实现获取数组第二大的数-要求时间复杂度-o-n",
        "link": "#实现获取数组第二大的数-要求时间复杂度-o-n",
        "children": []
      }
    ],
    "path": "/interview/handWrite.html",
    "pathLocale": "/",
    "extraFields": []
  },
  {
    ...
    "headers": [
      {
        ...
        "children": [
          {
            "level": 3,
            "title": "方案一：位置计算 + 滚动事件 (Scroll) + DataSet API",
            "slug": "方案一-位置计算-滚动事件-scroll-dataset-api",
            "link": "#方案一-位置计算-滚动事件-scroll-dataset-api",
            "children": []
          },
          {
            "level": 3,
            "title": "方案二：getBoundingClientRect API + Scroll with Throttle + DataSet API",
            "slug": "方案二-getboundingclientrect-api-scroll-with-throttle-dataset-api",
            "link": "#方案二-getboundingclientrect-api-scroll-with-throttle-dataset-api",
            "children": []
          },
          {
            "level": 3,
            "title": "方案三：IntersectionObserver API + DataSet API",
            "slug": "方案三-intersectionobserver-api-dataset-api",
            "link": "#方案三-intersectionobserver-api-dataset-api",
            "children": []
          },
          {
            "level": 3,
            "title": "方案四： LazyLoading 属性",
            "slug": "方案四-lazyloading-属性",
            "link": "#方案四-lazyloading-属性",
            "children": []
          }
        ]
      },
      {
        "level": 2,
        "title": "浏览器中如何实现剪切板复制的功能",
        "slug": "浏览器中如何实现剪切板复制的功能",
        "link": "#浏览器中如何实现剪切板复制的功能",
        "children": []
      },
      {
        "level": 2,
        "title": "如果把JSON数据转化为demo.json并下载",
        "slug": "如果把json数据转化为demo-json并下载",
        "link": "#如果把json数据转化为demo-json并下载",
        "children": [
          {
            "level": 3,
            "title": "方式一：json 视为字符串，可以利用 DataURL 进行下载",
            "slug": "方式一-json-视为字符串-可以利用-dataurl-进行下载",
            "link": "#方式一-json-视为字符串-可以利用-dataurl-进行下载",
            "children": []
          },
          {
            "level": 3,
            "title": "方式二：转化为 Object URL 进行下载",
            "slug": "方式二-转化为-object-url-进行下载",
            "link": "#方式二-转化为-object-url-进行下载",
            "children": []
          }
        ]
      },
      {
        "level": 2,
        "title": "如何找到当前页面出现次数最多的 HTML 标签",
        "slug": "如何找到当前页面出现次数最多的-html-标签",
        "link": "#如何找到当前页面出现次数最多的-html-标签",
        "children": []
      },
      {
        "level": 2,
        "title": "如何封装一个支持过期时间的 localStorage",
        "slug": "如何封装一个支持过期时间的-localstorage",
        "link": "#如何封装一个支持过期时间的-localstorage",
        "children": []
      },
      {
        "level": 2,
      ...
      {
        "level": 2,
        "title": "异步加载 JS 脚本时，async 与 defer 有何区别",
        "slug": "异步加载-js-脚本时-async-与-defer-有何区别",
        "link": "#异步加载-js-脚本时-async-与-defer-有何区别",
        "children": []
      },
      {
        "level": 2,
        "title": "React/Vue 中的 router 实现原理如何",
        "slug": "react-vue-中的-router-实现原理如何",
        "link": "#react-vue-中的-router-实现原理如何",
        "children": [
          {
            "level": 3,
            "title": "history API",
        ...
        "children": [
          {
            ...
            "slug": "什么是回调函数-callback",
            "link": "#什么是回调函数-callback",
            "children": []
          },
          {
            "level": 3,
  ...
  },
  {
    ...
    "path": "/interview/safetyProtection.html",
    "pathLocale": "/",
    "extraFields": []
  },
  {
    "title": "输入 URL 到页面展示，这中间发生了什么",
    "headers": [
      {
        "level": 2,
        "title": "导航流程",
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "level": 3,
            "title": "6. 栅格化（raster）操作",
            "slug": "_6-栅格化-raster-操作",
            "link": "#_6-栅格化-raster-操作",
            "children": []
          },
          {
            "level": 3,
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "level": 3,
            "title": "浏览器如何通过域名去查询 URL 对应的 IP 呢",
            "slug": "浏览器如何通过域名去查询-url-对应的-ip-呢",
            "link": "#浏览器如何通过域名去查询-url-对应的-ip-呢",
            "children": []
          }
        ]
      },
      {
        ...
        "children": [
          {
            "level": 3,
            "title": "为什么需要三次握手，两次不行吗？",
            "slug": "为什么需要三次握手-两次不行吗",
            "link": "#为什么需要三次握手-两次不行吗",
            "children": []
          },
          {
            "level": 3,
      ...
      {
        "level": 2,
        "title": "服务器处理请求并返回 HTTP 报文",
        "slug": "服务器处理请求并返回-http-报文",
        "link": "#服务器处理请求并返回-http-报文",
        "children": [
          {
            "level": 3,
            "title": "服务器",
  ...
  },
  {
    ...
    "headers": [
      ...
      {
        "level": 2,
        "title": "Number、String、Boolean、Symbol",
        "slug": "number、string、boolean、symbol",
        "link": "#number、string、boolean、symbol",
        "children": []
      },
      {
        "level": 2,
        "title": "object、Object 和 {}",
        "slug": "object、object-和",
        "link": "#object、object-和",
        "children": []
      },
      {
        "level": 2,
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "level": 3,
            "title": "数字字面量类型及布尔字面量类型",
            "slug": "数字字面量类型及布尔字面量类型",
            "link": "#数字字面量类型及布尔字面量类型",
            "children": []
          },
          {
            "level": 3,
  ...
  },
  {
    ...
    "headers": [
      ...
      {
        "level": 2,
        "title": "Chainable(可串联构造器)",
        "slug": "chainable-可串联构造器",
        "link": "#chainable-可串联构造器",
        "children": []
      },
      {
        "level": 2,
      ...
      {
        "level": 2,
        "title": "Trim、TrimLeft以及TrimRight",
        "slug": "trim、trimleft以及trimright",
        "link": "#trim、trimleft以及trimright",
        "children": []
      },
      {
        "level": 2,
      ...
      {
        "level": 2,
        "title": "AppendArgument（函数追加形参）",
        "slug": "appendargument-函数追加形参",
        "link": "#appendargument-函数追加形参",
        "children": []
      },
      {
        "level": 2,
    ...
    "path": "/typescript/challenge.html",
    "pathLocale": "/",
    "extraFields": []
  },
  {
    ...
    "headers": [
      ...
      },
      {
        ...
        "slug": "capitalize-首字母大写",
        "link": "#capitalize-首字母大写",
        "children": []
      }
    ],
    "path": "/typescript/challengeBuildIn.html",
    "pathLocale": "/",
    "extraFields": []
  },
  {
    ...
    "headers": [
      {
        "level": 2,
        "title": "使用 TypeScript 编写的代替 Object.keys 的方法",
        "slug": "使用-typescript-编写的代替-object-keys-的方法",
        "link": "#使用-typescript-编写的代替-object-keys-的方法",
        "children": []
      }
    ],
    "path": "/typescript/interview.html",
    "pathLocale": "/",
    "extraFields": []
  },
  {
    "title": "tsconfig.json介绍",
    "headers": [
      {
        "level": 2,
        "title": "tsconfig.json 重要字段",
        "slug": "tsconfig-json-重要字段",
        "link": "#tsconfig-json-重要字段",
        "children": []
      },
      {
        "level": 2,
        "title": "compilerOptions 选项",
        "slug": "compileroptions-选项",
        "link": "#compileroptions-选项",
        "children": []
      }
    ],
